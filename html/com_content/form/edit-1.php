...
<form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
		...
		<span style="color:#800000;font-size:12px;"> 注：多个关键词请使用英文字符逗号( , )隔开</span>
		</div>
<!--categories selector   -->	
	...
	<?php if ($this->item->params->get('access-change')): ?>
		...
		<span style="color:#800000">只适用于以下新闻模块：从“纽约焦点”到“芝加哥”。 如果要把这条新闻设为置顶，请必须把当前置顶显示的那一条新闻，设为“否”,才能正确显示！</span>
		</div>
