...
<?php 
	...
	if ($nav == false):	  
	  ...
	  $itemtext = str_replace("</div>","</p>",$itemtext);
	  //$itemtext = str_replace("<span","<p",$itemtext);
	  //$itemtext = str_replace("</span>","</p>",$itemtext);
	 // $itemtext = str_replace('\n\n', '\n', $itemtext); 
	 // $itemtext = str_replace("/\n\n+/s","\n",$itemtext);
	  //$itemtext = str_replace("\n","</p><p>",$itemtext);
	  $itemtext = str_replace("<br />","</p><p>",$itemtext);
	  //$itemtext = str_replace('<p></p>','',$itemtext);
	  //$itemtext = str_replace('<p> </p>','',$itemtext);
	endif;
	//Remove all the html elements
	$itemtext = strip_tags($itemtext,'<p>,<span>,<div>,<img>,<ul>,<li>,<a>,<embed>,<strong>,<h1>,<h2>,<h3>,<h4>,<b>,<em>,<ol>,<table>,<tbody>,<tr>,<td>,<hr />,<frame>,<iframe>,<i>');
