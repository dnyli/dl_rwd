...
if (is_array($rows)) {
	...
	<td width="15%"><a href="<?php echo $linkEdit; ?>" title="<?php echo JText::_( 'COM_PHOCAGALLERY_EDIT_IMAGE' ); ?>"><?php echo $row->title; ?></a></td>
	<?php 
	...
	echo '<td align="center" width="20%">'. $row->category .'</td>';
