...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline" >
	...
	<?php endif; ?>
	<ul id="loginbox" class="col-sm-12">
		
			<p id="form-login-username">
				<label class="sr-only" for="modlgn-username"><?php echo JText::_('MOD_LOGIN_VALUE_USERNAME')  ?></label>
				<input id="modlgn-username" type="text" name="username" class="form-control"  size="16" placeholder="用户名" />
			</p>
			<p id="form-login-password">
				<label class="sr-only" for="modlgn-passwd"><?php echo JText::_('JGLOBAL_PASSWORD') ?></label>
				<input id="modlgn-passwd" type="password" name="password" class="form-control" size="16" placeholder="密码" />
			</p>
